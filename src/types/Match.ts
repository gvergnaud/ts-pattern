...
import type { MatchedValue, Pattern } from "./Pattern.ts";
import type {
  InvertPattern,
  InvertPatternForExclude,
} from "./InvertPattern.ts";
import type { DeepExclude } from "./DeepExclude.ts";
import type { GuardValue, IsNever, Union } from "./helpers.ts";
...
> = {
  ...
  ): InvertPatternForExclude<p, value> extends infer excluded ? Match<
      Exclude<i, excluded>,
      o,
  ...
  ] extends [infer excluded1, infer excluded2] ? Match<
  ...
  ): pred extends (value: any) => value is infer narrowed ? Match<
      Exclude<i, narrowed>,
      o,
