import { match, not, Pattern, select, isString, isNumber, __ } from '../src';
    ...
    expect(
      match<LargeObject | null>(null)
        ...
        .with(
          // prettier-ignore
          {
            a1: isNumber, b1: isNumber, c1: isNumber, d1: isNumber, e1: isNumber, f1: isNumber, g1: isNumber, h1: isNumber, i1: isNumber, j1: isNumber, k1: isNumber, l1: isNumber, m1: isNumber, n1: isNumber, o1: isNumber, p1: isNumber, q1: isNumber, r1: isNumber, s1: isNumber, t1: isNumber, u1: isNumber, v1: isNumber, w1: isNumber, x1: isNumber, y1: isNumber, z1: isNumber,
            a2: isNumber, b2: isNumber, c2: isNumber, d2: isNumber, e2: isNumber, f2: isNumber, g2: isNumber, h2: isNumber, i2: isNumber, j2: isNumber, k2: isNumber, l2: isNumber, m2: isNumber, n2: isNumber, o2: isNumber, p2: isNumber, q2: isNumber, r2: isNumber, s2: isNumber, t2: isNumber, u2: isNumber, v2: isNumber, w2: isNumber, x2: isNumber, y2: isNumber, z2: isNumber,
            a3: isNumber, b3: isNumber, c3: isNumber, d3: isNumber, e3: isNumber, f3: isNumber, g3: isNumber, h3: isNumber, i3: isNumber, j3: isNumber, k3: isNumber, l3: isNumber, m3: isNumber, n3: isNumber, o3: isNumber, p3: isNumber, q3: isNumber, r3: isNumber, s3: isNumber, t3: isNumber, u3: isNumber, v3: isNumber, w3: isNumber, x3: isNumber, y3: isNumber, z3: isNumber,
          },
          () => 'nope'
        )
        .exhaustive()
    ...
    expect(
      match<DeepObject | null>(null)
        ...
        .with(
          ...
          {
            1: { 2: { 3: { 4: {
              a: isNumber, b: isNumber, c: isNumber, d: isNumber, e: isNumber, f: isNumber, g: isNumber, h: isNumber, i: isNumber, j: isNumber, k: isNumber, l: isNumber, m: isNumber, n: isNumber, o: isNumber, p: isNumber, q: isNumber, r: isNumber, s: isNumber, t: isNumber, u: isNumber, v: isNumber, w: isNumber, x: isNumber, y: isNumber, z: isNumber, 
            } } } }
          },
          () => 'nope'
        )
