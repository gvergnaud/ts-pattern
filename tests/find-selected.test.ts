import type * as symbols from "../src/internals/symbols.ts";
import type {
  FindSelected,
...
Deno.test("list selections should be wrapped in arrays", () => {
  type cases = [
    Expect<
      Equal<
...
Deno.test("should correctly return a positional argument", () => {
  type cases = [
    Expect<
      Equal<
        FindSelected<
...
Deno.test("should return an error when trying to use several anonymous select", () => {
  type cases = [
    Expect<
      Equal<
        FindSelected<
...
Deno.test("should return the input type", () => {
...
Deno.test("shouldn't change optional properties", () => {
  type p = {
    type: "a";
    data: OptionalP<
      | {
