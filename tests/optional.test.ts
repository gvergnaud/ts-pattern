...
Deno.test("should match even if the sub pattern is undefined", () => {
...
Deno.test("should support a nested pattern", () => {
...
Deno.test("should support anonymous select", () => {
  type Input =
...
Deno.test("should support named select", () => {
...
Deno.test("should support list patterns", () => {
